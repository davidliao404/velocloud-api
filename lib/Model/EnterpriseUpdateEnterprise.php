...
/**
 * EnterpriseUpdateEnterprise Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseUpdateEnterprise implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'enterprise_update_enterprise';
    ...
    protected static $swaggerTypes = [
        'enterprise_id' => 'int',
        'name' => 'string',
        '_update' => '\Swagger\Client\Model\EnterpriseObject'
    ];
     ...
     * Sets _update
     *
     * @param \Swagger\Client\Model\EnterpriseObject $_update _update
     *
     * @return $this
     */
