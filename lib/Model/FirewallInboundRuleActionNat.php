...
/**
 * FirewallInboundRuleActionNat Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FirewallInboundRuleActionNat implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'firewall_inbound_rule_action_nat';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lan_port'] = isset($data['lan_port']) ? $data['lan_port'] : null;
    ...
    {
        return $this->container['lan_port'];
    }

    /**
     * Sets lan_port
     *
     * @param int $lan_port lan_port
     *
     * @return $this
     */
    public function setLanPort($lan_port)
    {
        $this->container['lan_port'] = $lan_port;
