...
/**
 * FirewallInboundRuleAction Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FirewallInboundRuleAction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'firewall_inbound_rule_action';
    ...
    protected static $swaggerTypes = [
        'type' => 'string',
        'nat' => '\Swagger\Client\Model\FirewallInboundRuleActionNat',
        'interface' => 'string',
        'subinterface_id' => 'int'
    ];
    ...
    const TYPE_PORT_FORWARDING = 'port_forwarding';
    const TYPE_ONE_TO_ONE_NAT = 'one_to_one_nat';
    ...
    {
        return [
            self::TYPE_PORT_FORWARDING,
            self::TYPE_ONE_TO_ONE_NAT,
        ];
    }
     ...
     * Gets nat
     *
     * @return \Swagger\Client\Model\FirewallInboundRuleActionNat
     */
     ...
     * Sets nat
     *
     * @param \Swagger\Client\Model\FirewallInboundRuleActionNat $nat nat
     *
     * @return $this
     */
     ...
     * Sets interface
     *
     * @param string $interface The name of the interface from which traffic should be forwarded
     *
     * @return $this
     */
