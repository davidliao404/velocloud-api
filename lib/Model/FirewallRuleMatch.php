...
/**
 * FirewallRuleMatch Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FirewallRuleMatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'firewall_rule_match';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['smac'] = isset($data['smac']) ? $data['smac'] : null;
        ...
        $this->container['dmac'] = isset($data['dmac']) ? $data['dmac'] : null;
     ...
     * Sets appid
     *
     * @param int $appid Integer ID corresponding to an application in the network-level application map
     *
     * @return $this
     */
     ...
     * Sets classid
     *
     * @param int $classid Integer ID corresponding to an application class in the network-level application map
     *
     * @return $this
     */
     ...
     * Sets dscp
     *
     * @param int $dscp Integer ID indicating DSCP classification
     *
     * @return $this
     */
     ...
     * Sets sip
     *
     * @param string $sip Source IP address
     *
     * @return $this
     */
     ...
     * Sets sport_high
     *
     * @param int $sport_high Upper bound of a source port range
     *
     * @return $this
     */
     ...
     * Sets sport_low
     *
     * @param int $sport_low Lower bound of a source port range
     *
     * @return $this
     */
     ...
     * Sets ssm
     *
     * @param string $ssm Source subnet mask, e.g. 255.255.255.0
     *
     * @return $this
     */
    ...
    {
        return $this->container['smac'];
    }

    /**
     * Sets smac
     *
     * @param string $smac Source MAC address
     *
     * @return $this
     */
    public function setSmac($smac)
    {
        $this->container['smac'] = $smac;
     ...
     * Sets svlan
     *
     * @param int $svlan Integer ID for the source VLAN
     *
     * @return $this
     */
     ...
     * Sets dip
     *
     * @param string $dip Destination IP address
     *
     * @return $this
     */
     ...
     * Sets dport_low
     *
     * @param int $dport_low Lower bound of a destination port range
     *
     * @return $this
     */
     ...
     * Sets dport_high
     *
     * @param int $dport_high Upper bound of a destination port range
     *
     * @return $this
     */
     ...
     * Sets dsm
     *
     * @param string $dsm Destination subnet mask e.g. 255.255.255.0
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getDmac()
    {
        return $this->container['dmac'];
    }

    /**
     * Sets dmac
     *
     * @param string $dmac Destination MAC address
     *
     * @return $this
     */
    public function setDmac($dmac)
    {
        $this->container['dmac'] = $dmac;
     ...
     * Sets dvlan
     *
     * @param int $dvlan Integer ID for the destination VLAN
     *
     * @return $this
     */
     ...
     * Sets proto
     *
     * @param int $proto Integer ID corresponding to a protocol
     *
     * @return $this
     */
