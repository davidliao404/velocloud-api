...
/**
 * EnterpriseGetEnterpriseServices Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EnterpriseGetEnterpriseServices implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'enterprise_get_enterprise_services';
    ...
    const WITH_PROFILE_COUNT = 'profileCount';
    const WITH_EDGE_USAGE = 'edgeUsage';
    ...
    {
        return [
            self::WITH_PROFILE_COUNT,
            self::WITH_EDGE_USAGE,
