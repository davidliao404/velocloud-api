 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdgeGetEdge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'edge_get_edge';
    ...
    const WITH_RECENT_LINKS = 'recentLinks';
    const WITH_LINKS = 'links';
    const WITH_SERVICE_GROUPS = 'serviceGroups';
    const WITH_SITE = 'site';
    const WITH_ENTERPRISE = 'enterprise';
    const WITH_CONFIGURATION = 'configuration';
    const WITH_CONFIGURATION_WITH_MODULES = 'configurationWithModules';
    ...
    {
        return [
            self::WITH_RECENT_LINKS,
            self::WITH_LINKS,
            self::WITH_SERVICE_GROUPS,
            self::WITH_SITE,
            self::WITH_ENTERPRISE,
            self::WITH_CONFIGURATION,
            self::WITH_CONFIGURATION_WITH_MODULES,
        ];
    }
