...
/**
 * GatewayEnterpriseAssoc Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GatewayEnterpriseAssoc implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'gateway_enterprise_assoc';
    ...
    protected static $attributeMap = [
        ...
        'enterprise_object_type' => 'enterpriseObjectType',
        'edge_name' => 'edgeName',
    ...
    protected static $setters = [
        ...
        'enterprise_object_type' => 'setEnterpriseObjectType',
    ...
    protected static $getters = [
        ...
        'enterprise_object_type' => 'getEnterpriseObjectType',
    ...
    const GATEWAY_TYPE_OTHER = 'OTHER';
    const GATEWAY_TYPE_SUPER = 'SUPER';
    const GATEWAY_TYPE_DATACENTER = 'DATACENTER';
    const GATEWAY_TYPE_HANDOFF = 'HANDOFF';
    ...
    {
        return [
            self::GATEWAY_TYPE_OTHER,
            self::GATEWAY_TYPE_SUPER,
            self::GATEWAY_TYPE_DATACENTER,
            self::GATEWAY_TYPE_HANDOFF,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['enterprise_object_type'] = isset($data['enterprise_object_type']) ? $data['enterprise_object_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['gateway_type'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getGatewayTypeAllowableValues();
        if (!is_null($gateway_type) && !in_array($gateway_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'gateway_type', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    /**
     * Gets enterprise_object_type
     *
     * @return string
     */
    public function getEnterpriseObjectType()
    {
        return $this->container['enterprise_object_type'];
    }

    /**
     * Sets enterprise_object_type
     *
     * @param string $enterprise_object_type enterprise_object_type
     *
     * @return $this
     */
    public function setEnterpriseObjectType($enterprise_object_type)
    {
        $this->container['enterprise_object_type'] = $enterprise_object_type;
