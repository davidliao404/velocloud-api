...
class EdgeApi
{
    ...
    /**
     * Operation edgeGetClientVisibilityMode
     *
     * Get an edge's client visibility mode
     *
     * @param  \Swagger\Client\Model\EdgeGetClientVisibilityMode $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\EdgeGetClientVisibilityModeResult
     */
    public function edgeGetClientVisibilityMode($body)
    {
        list($response) = $this->edgeGetClientVisibilityModeWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation edgeGetClientVisibilityModeWithHttpInfo
     *
     * Get an edge's client visibility mode
     *
     * @param  \Swagger\Client\Model\EdgeGetClientVisibilityMode $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\EdgeGetClientVisibilityModeResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function edgeGetClientVisibilityModeWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\EdgeGetClientVisibilityModeResult';
        $request = $this->edgeGetClientVisibilityModeRequest($body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\EdgeGetClientVisibilityModeResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation edgeGetClientVisibilityModeAsync
     *
     * Get an edge's client visibility mode
     *
     * @param  \Swagger\Client\Model\EdgeGetClientVisibilityMode $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function edgeGetClientVisibilityModeAsync($body)
    {
        return $this->edgeGetClientVisibilityModeAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation edgeGetClientVisibilityModeAsyncWithHttpInfo
     *
     * Get an edge's client visibility mode
     *
     * @param  \Swagger\Client\Model\EdgeGetClientVisibilityMode $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function edgeGetClientVisibilityModeAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\EdgeGetClientVisibilityModeResult';
        $request = $this->edgeGetClientVisibilityModeRequest($body);
    ...
    /**
     * Create request for operation 'edgeGetClientVisibilityMode'
     *
     * @param  \Swagger\Client\Model\EdgeGetClientVisibilityMode $body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function edgeGetClientVisibilityModeRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling edgeGetClientVisibilityMode'
            );
        }

        $resourcePath = '/edge/getClientVisibilityMode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
