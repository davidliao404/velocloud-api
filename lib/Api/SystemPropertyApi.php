...
/**
 * SystemPropertyApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class SystemPropertyApi
{
    ...
    /**
     * Operation systemPropertyGetSystemProperties
     *
     * Get all system properties
     *
     * @param  \Swagger\Client\Model\SystemPropertyGetSystemProperties $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SystemPropertyGetSystemPropertiesResultItem[]
     */
    public function systemPropertyGetSystemProperties($body)
    {
        list($response) = $this->systemPropertyGetSystemPropertiesWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation systemPropertyGetSystemPropertiesWithHttpInfo
     *
     * Get all system properties
     *
     * @param  \Swagger\Client\Model\SystemPropertyGetSystemProperties $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SystemPropertyGetSystemPropertiesResultItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function systemPropertyGetSystemPropertiesWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SystemPropertyGetSystemPropertiesResultItem[]';
        $request = $this->systemPropertyGetSystemPropertiesRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SystemPropertyGetSystemPropertiesResultItem[]',
    ...
    /**
     * Operation systemPropertyGetSystemPropertiesAsync
     *
     * Get all system properties
     *
     * @param  \Swagger\Client\Model\SystemPropertyGetSystemProperties $body (required)
     ...
     */
    public function systemPropertyGetSystemPropertiesAsync($body)
    {
        return $this->systemPropertyGetSystemPropertiesAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation systemPropertyGetSystemPropertiesAsyncWithHttpInfo
     *
     * Get all system properties
     *
     * @param  \Swagger\Client\Model\SystemPropertyGetSystemProperties $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemPropertyGetSystemPropertiesAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SystemPropertyGetSystemPropertiesResultItem[]';
        $request = $this->systemPropertyGetSystemPropertiesRequest($body);
    ...
    /**
     * Create request for operation 'systemPropertyGetSystemProperties'
     *
     * @param  \Swagger\Client\Model\SystemPropertyGetSystemProperties $body (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function systemPropertyGetSystemPropertiesRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling systemPropertyGetSystemProperties'
            );
        }

        $resourcePath = '/systemProperty/getSystemProperties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
